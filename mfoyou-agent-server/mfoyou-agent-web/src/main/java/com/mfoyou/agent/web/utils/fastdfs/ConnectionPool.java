...
import org.mfoyou.agent.common.fastDfs.fastdfs.ClientGlobal;
import org.mfoyou.agent.common.fastDfs.fastdfs.ProtoCommon;
import org.mfoyou.agent.common.fastDfs.fastdfs.TrackerClient;
...
public class ConnectionPool {  
    ...
    public void createTrackerServer(String logId, int flag) {  
        ...
        try {  
            ...
            ProtoCommon.activeTest(trackerServer  
                    .getSocket());  
    ...
    private void initClientGlobal() throws Exception {  
        ClientGlobal.init(this.getClass().getClassLoader().getResource("/").getPath()+"system.properties");  
    }  
