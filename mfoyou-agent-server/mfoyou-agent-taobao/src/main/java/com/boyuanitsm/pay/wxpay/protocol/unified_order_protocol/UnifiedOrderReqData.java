...
public class UnifiedOrderReqData {
    ...
    private UnifiedOrderReqData(String body, String out_trade_no, int total_fee) {
        ...
        this.notify_url = Configure.getCallBackUrl();
    }
     ...
     * @throws IllegalAccessException
     */
    public UnifiedOrderReqData(String body, int total_fee, String out_trade_no, String appid) throws IllegalAccessException {
        this(body, out_trade_no, total_fee);
        this.trade_type = "APP";
        if(appid!=null){
        	this.appid=appid;
     ...
     * @throws IllegalAccessException
     */
    public UnifiedOrderReqData(String body, int total_fee, String out_trade_no, String appid,boolean isF) throws IllegalAccessException {
        this(body, out_trade_no, total_fee);
        this.trade_type = "NATIVE";
        if(appid!=null){
        	this.appid=appid;
     ...
     * @throws IllegalAccessException
     */
    public UnifiedOrderReqData(String body, String out_trade_no, String openid, int total_fee, String appid) throws IllegalAccessException {
        this(body, out_trade_no, total_fee);
        this.trade_type = "JSAPI";
        this.openid = openid;
        if(appid!=null){
    ...
    public UnifiedOrderReqData(String body, String out_trade_no, int total_fee, boolean b) {
          this.mch_id = Configure.getMchid();
          this.device_info = "WEB";
          this.nonce_str = RandomStringGenerator.getRandomStringByLength(Configure.NONCE_STR_LENGTH);
          this.body = body;
